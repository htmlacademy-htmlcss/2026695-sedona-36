...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/2026695-sedona-36) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
...
Для установки зависимостей понадобится терминал. В Windows лучше установить _git-bash_, который идёт в комплекте с самим [Git](https://git-scm.com/download/windows).

#### 4.2. Node.js

Зависимости работают в среде _node.js_, которую тоже нужно установить, но лучше не с помощью установщика с официального сайта, а через менеджер версий ноды — [_nvm_](https://github.com/coreybutler/nvm-windows/releases).

Далее надо выполнить в терминале _git-bash_ команду:

```bash
nvm install 18.13.0
```

Затем закрыть терминал _git-bash_. Снова его запустить, но уже от имени администратора, и выполнить:
...
[check-image]: https://github.com/htmlacademy-htmlcss/2026695-sedona-36/workflows/Project%20check/badge.svg?branch=master
[check-url]: https://github.com/htmlacademy-htmlcss/2026695-sedona-36/actions
